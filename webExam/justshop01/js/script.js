$(function(){
    ...
    setInterval(slideUpDown, 3000); //setInterval == 함수 실행 메소드 , 시간 3초에 1번씩 실행되도록

    $('.pop').click(function(e){
        e.preventDefault(); //a태그의 기능을 죽인다.
        $('.popup').fadeIn();
    });
...
function slideUpDown(){ //함수명
    $('.heroin').animate({
        top: '-300px' //1번째 이미지를 위로 -300만큼 애니메이션 한다.
        ...
        $('.heroin img:eq(0)').clone().appendTo('.heroin'); //1번째거를 박스 끝에 붙혀줌
